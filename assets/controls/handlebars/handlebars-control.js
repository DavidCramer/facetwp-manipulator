...
!( jQuery( function($){
    ...
    conduitBuildUI = function( app ){
        ...
        // sortables
        if( $('.fwpmanip-sortable').length ){
            $('.fwpmanip-sortable').each( function(){
                var sort = $(this),
                    options = {
                        forcePlaceholderSize : true,
                        placeholder: "fwpmanip-sortable-placeholder"
                    };
    ...
    $(document).on('click', '.fwpmanip-notice .notice-dismiss', function(){
        var parent =  $( this ).closest( '.fwpmanip-notice' );
    ...
    $(document).on( 'click', '[data-modal-node]', function( e ) {
        ...
        if( type !== 'delete' ){
            try{
                data = clicked.closest('.fwpmanip-modal-wrap').getObject();
            }catch (e){
                return;
            }
        }
    ...
    $(document).on('fwpmanip.itemsubmit', function(){
        conduitPrepObject();
    })
    // register apps
