 ...
 * @since 1.0.0
 */
class markdown extends \fwpmanip\ui\control\textarea {
	...
	public function set_assets() {
		...
		$this->assets['script']['markdown-init'] = $this->url . 'assets/controls/markdown/markdown-init' . FWPMANIP_ASSET_DEBUG . '.js';
