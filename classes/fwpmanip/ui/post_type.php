...
/**
 * FWPMANIP Post Type class for adding custom post types
 * @package fwpmanip\ui
 * @author  David Cramer
 */
class post_type extends fwpmanip {
	...
	/**
	 * Define core FWPMANIP styling to identify FWPMANIP post types
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function set_assets() {
		$this->assets['style']['post'] = $this->url . 'assets/css/post' . FWPMANIP_ASSET_DEBUG . '.css';
		parent::set_assets();
	}
