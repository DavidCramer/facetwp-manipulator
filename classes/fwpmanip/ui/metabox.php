...
class metabox extends panel {
	...
	public function set_assets() {
		...
		$this->assets['style']['metabox'] = $this->url . 'assets/css/metabox' . FWPMANIP_ASSET_DEBUG . '.css';
	...
	protected function set_active_styles() {
		...
		$style = '#' . $this->id() . '.fwpmanip-top-tabs > .fwpmanip-panel-tabs > li[aria-selected="true"] a,';
		$style .= '#side-sortables #' . $this->id() . ' > .fwpmanip-panel-tabs > li[aria-selected="true"] a {';
		$style .= 'box-shadow: 0 3px 0 ' . $this->base_color() . ' inset; }';

		$style .= '#' . $this->id() . ' > .fwpmanip-panel-tabs > li[aria-selected="true"] a {';
